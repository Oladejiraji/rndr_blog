...
**Alternative:** The [View Transitions API](https://developer.mozilla.org/en-US/docs/Web/API/View_Transitions_API) offers a native browser solution for page transitions, though browser support is still evolving and it requires different integration patterns with Next.js.
...
```tsx title=page.tsx {1,7,14,16-22,25}
...
```tsx title=page.tsx {5-11,14-15,17-25}
