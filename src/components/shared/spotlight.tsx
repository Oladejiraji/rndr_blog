  ...
  return (
    <div>
      <div className="relative mx-5 md:mx-0">
        ...
        <Input
          className="rounded-t-[20px] bg-[#F5F5F5] md:bg-transparent rounded-full md:rounded-b-none border-none pl-10 pr-4 py-5 h-10 md:h-16 placeholder:text-gray-1100 text-base "
